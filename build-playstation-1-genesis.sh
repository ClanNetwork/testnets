...
cland export-snapshot ./$SNAPSHOT_TERRA_STAKERS ./$SNAPSHOT_TERRA_STAKERS-output.json $COSMOS_AIRDROP_ALLOCATION $EXCHANGES_TERRA --minStaked=10000000 --whalecap=200000000000  
